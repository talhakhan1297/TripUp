...
class ListOfTrains extends StatefulWidget {
  @override
  _ListOfTrainsState createState() => _ListOfTrainsState();
}

class _ListOfTrainsState extends State<ListOfTrains> {
...
class TrainList extends StatelessWidget {
  ...
  final List<TrainClass> lst = [
    TrainClass("First Class", 35, 50),
    TrainClass("First Class", 35, 50),
    TrainClass("First Class", 35, 50),
    TrainClass("First Class", 35, 50),
    TrainClass("First Class", 35, 50),
...
class TrainClass extends StatelessWidget {
  final String trainclass;
  final double trainPrice;
  final double number;

  TrainClass(this.trainclass, this.trainPrice, this.number);
