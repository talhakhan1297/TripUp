...
class CabTickets extends StatelessWidget {
  CabTickets(
    this.title,
    this.heading1,
    this.subheading1,
            ...
            child: Card(
              ...
              child: Column(
                children: <Widget>[
                      ...
                      child: Column(
                        children: <Widget>[
                          ...
                          Row(
                            ...
                            children: <Widget>[
                              Container(
                                width: (deviceInfo.size.width - 125) / 2,
                                child: Text(
                                  fromSubHeading,
                                  style: TextStyle(
                                    color: Colors.white,
                              ...
                              Container(
                                ...
                                width: (deviceInfo.size.width - 150) / 2,
                                child: Text(
                                  toSubHeading,
                  ...
                  Padding(
                    padding: const EdgeInsets.fromLTRB(16.0, 0, 24, 32),
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: <Widget>[
