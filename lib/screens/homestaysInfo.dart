import 'package:TripUp/screens/homestayBook.dart';
...
class HomestaysInfo extends StatefulWidget {
  @override
  _HomestaysInfoState createState() => _HomestaysInfoState();
}

class _HomestaysInfoState extends State<HomestaysInfo> {
  int _current = 0;
                        ...
                        child: Container(
                          ...
                          child: ListView(
                            ...
                            children: <Widget>[
                              ...
                              floatingBar(Icons.pool, "Pool"),
                              floatingBar(Icons.local_dining, "Kitchen"),
                              floatingBar(Icons.hot_tub, "Geyser"),
                              floatingBar(Icons.wifi, "WiFi"),
                              floatingBar(Icons.ac_unit, "AC"),
                              floatingBar(Icons.tv, "TV"),
                              floatingBar(Icons.pool, "Pool"),
                  ...
                  child: FlatButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => HomestayBooking(
                                "Homestay Booked",
                                "Hotel Sky Garden",
                                "City Park, Manhattan",
                                "\$135.00",
